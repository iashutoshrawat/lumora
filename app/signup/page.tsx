  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-surface/80 backdrop-blur-lg p-6 border-2 border-border shadow-xl relative z-10 animate-fade-in">
        ...
        <p className="text-muted-foreground text-center mb-6 text-sm">Create your Lumora account</p>

        {error && (
          <div className="mb-4 p-3 bg-destructive/10 border-2 border-destructive/20 rounded-lg flex items-start gap-2">
        ...
        <p className="text-center text-muted-foreground mt-5 text-xs">
